    ...
    document.write("<script language='javascript' src='echarts.js'></script>");
        ...
        var myChart1 = echarts.init(document.getElementById('relationship'),'dark');

       option1 = {
            // title: { text: '人物关系图谱' ,left:'40%'},
            ...
            series: [
                {
                    ...
                    itemStyle: {
                        normal: {
                            //color: 'rgba(7, 193, 244,1)',
                            borderWidth:20,
                            //borderColor:'rgba(7, 193, 244,0.2)'
                        }
                    },
                    ...
                    data: [
                        {
                            ...
                            //symbol:'image://./img/pic1.jpg',
                            symbolSize: 150,
                            itemStyle: {
                                normal: {
                                    color: 'rgb(230,157,135)',
                                    borderWidth:30,
                            borderColor:'rgba(230,157,135,0.2)'
                                }
                            },
                            zlevel:5
                            ...
                            itemStyle: {
                                normal: {
                                    ...
                                    borderWidth:20,
                            borderColor:'rgba(221,107,102,0.2)'
                                }}
                        }, {
                            name: '祁同伟',
                            des: '汉东省公安厅厅长',
                            ...
                            itemStyle: {
                                normal: {
                                    ...
                                    borderWidth:25,
                            borderColor:'rgba(117,154,160,0.2)'
                                }}
                        }, {
                            name: '陈岩石',
                            ...
                            itemStyle: {
                                normal: {
                                    ...
                                    borderWidth:25,
                            borderColor:'rgba(114,137,171,0.2)'
                                }}
                        }, {
                            name: '沙瑞金',
                            des: '汉东省省委书记',
